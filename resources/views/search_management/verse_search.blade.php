                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach($versesData as $verseRow)
                                <tr class="hover:bg-gray-50 transition-colors duration-300">
                                    ...
                                    <td class="px-4 py-2 text-gray-700 text-sm" style="text-align: justify;">{!! $verseRow['tagalog_explanation'] !!}</td>
                                    <td class="px-4 py-2 text-gray-700 text-sm" style="text-align: justify;">{!! $verseRow['translation_explanation'] !!}</td>
